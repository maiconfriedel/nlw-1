...
const CreatePoint: React.FC = () => {
  ...
  // buscar cidades quando alterar uf
  useEffect(() => {
    axios
  ...
  function handleSelectUf(ev: React.ChangeEvent<HTMLSelectElement>) {
    const uf = ev?.target.value;

    setSelectedUf(uf);
  }

  function handleSelectCity(ev: React.ChangeEvent<HTMLSelectElement>) {
